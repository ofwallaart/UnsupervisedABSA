...
bert_mapper = {
    ...
    'restaurant-nl': '/dbfs/FileStore/kto/restaurant-nl/pt_runs/pt_bertselect-Bert',
}
...
path_mapper = {
    ...
    'restaurant-nl': '/dbfs/FileStore/kto/restaurant-nl',
}
aspect_category_mapper = {
    ...
    'restaurant-nl': ['location', 'drinks', 'food', 'ambience', 'service'],
...
aspect_seed_mapper = {
    ...
    'restaurant-nl': {
          ...
          'ambience': {"sfeer", "atmosfeer", "ruimte", "zitplek", "inrichting"},
          'service': {"service", "fooi", "manager", "serveerster", "personeel"}
      },
    'kto': {
...
sentiment_category_mapper = {
    ...
    'restaurant-nl': ['negative', 'positive'],
...
sentiment_seed_mapper = {
    ...
    #},
    'restaurant-nl': {
        'positive': {"goed", "geweldig", 'nice', "excellent", "perfect"},
...
weights = {
    'aspect_weights': {
        ...
        'restaurant-nl': [2, 10, 125, 29, 84],#[345, 67, 201]
    },
    'sentiment_weights': {
        'laptop': [157, 150],
        'restaurant': [231, 382],
        'kto': [927, 35],
        'restaurant-nl': [115, 135],
    }
}
