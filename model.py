...
class BERTLinear(nn.Module):
    def __init__(self, bert_type, num_cat, num_pol):
        ...
        self.aspect_weights = [283, 175, 162, 214, 89, 118, 320, 585, 104, 144, 180] # [0, 319, 179, 95, 150, 203, 184] #[345, 67, 201] # aspect category distribution (restaurant) [1, 4, 6, 3, 1, 5, 2, 1, 1, 2, 1, 10, 1, 7, 1, 2, 56, 9, 2, 3, 2, 3] #
        self.sentiment_weights = [819, 1524] # sentiment category distribution (restaurant) [46, 73] #
